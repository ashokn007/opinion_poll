...
<div class="row">
    <div class="col-sm-3 col-md-2 sidebar">
        <ul class="nav nav-sidebar">
            <li class="active"><a class=""  href="<?= base_url() ?>admin_voting/create" >Add Question</a></li>
            <li><a class="" href="<?= base_url() ?>admin_voting">Questions lists</a></li>
            <li><a class="" href="<?= base_url() ?>voting">Show Question</a></li>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-6 col-md-offset-2 main">
        ...
        <?php echo form_open_multipart('admin/create/', array('class' => 'form-horizontal')) ?>

            <div class="form-group">
                <input id="dv_title" class="form-control" name="dv_title" placeholder="Question title" value="<?= set_value('dv_title') ?>"/>
            ...
            <input class="btn btn-primary" type="submit" name="save" value="Create Question"/>
