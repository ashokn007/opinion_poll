...
<div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-6 col-md-offset-2 main">
        ...
        <?= form_open_multipart('admin/edit/' . $vote->dv_id, array('class' => 'form-horizontal')) ?>
        <div class="form-group">
            <label class="control-label col-sm-4">Question Title</label>
        ...
        <input class="btn btn-primary" type="submit" name="save" value="Edit Question"/>
